...
var SerachUsersService = (function () {
    ...
    SerachUsersService.prototype.getUsersByPlace = function (place, language) {
        var url;
        if (place && !language) {
    ...
    SerachUsersService.prototype.getDetailsByLogin = function (login) {
        if (login) {
            var url = "" + this.getUserDetailsEndPoint + login;
            return this.http.get(url)
...
var SearchUsersComponent = (function () {
    ...
    SearchUsersComponent.prototype.search = function (place, language) {
        ...
        if (place || language) {
            ...
            this.serachService.getUsersByPlace(place, language).subscribe(function (users) {
                _this.results = users;
            }, function (error) {
                _this.results = [];
    ...
    SearchUsersComponent.prototype.getDetails = function (username) {
        var _this = this;
        this.serachService.getDetailsByLogin(username).subscribe(function (userDatils) {
